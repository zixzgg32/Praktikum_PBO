...
import sistem.pemesanan.bilik.warnet.entitas.Member;
import sistem.pemesanan.bilik.warnet.entitas.NonMember;
...
public final class App {
    ...
    private static void loginAdmin() {
        ...
        try {
            ...
            System.out.println("Terjadi kesalahan saat login admin: " + e.getMessage());
        }
    }
    ...
    private static void loginPelanggan() {
        ...
        try {
            ...
            System.out.println("Terjadi kesalahan saat login pelanggan: " + e.getMessage());
        }
    }
    ...
    private static void registerPelanggan() {
        ...
        try {
            ...
            if (isMember.equalsIgnoreCase("y")) {
                ...
                scanner.nextLine();
                final Member member = new Member(0, nama, email, password, noHp, discountRate);
                pelangganService.registerPelanggan(member);
            } else {
                final Pelanggan newPelanggan = new NonMember(0, nama, email, password, noHp);
                pelangganService.registerPelanggan(newPelanggan);
            }
            System.out.println("Registrasi berhasil!");
        } catch (Exception e) {
            System.out.println("Terjadi kesalahan saat registrasi pelanggan: " + e.getMessage());
        }
    ...
    private final static void initializePelanggan() {
        NonMember pelanggan1 = new NonMember(1, "jorip", "jorip@gmail.com", "123", "081234567890");
        pelangganService.registerPelanggan(pelanggan1);
        Member pelanggan2 = new Member(2, "Ijopr", "ijopr@gmail.com", "123", "081234567891", 0.1);
        pelangganService.registerPelanggan(pelanggan2);
    }
