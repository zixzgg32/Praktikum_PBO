...
public class JadwalPemakaian {
    ...
    public JadwalPemakaian(int idJadwal, int idPemesanan, int idPelanggan, int idAdmin, int idBilik,
            LocalDateTime waktuMulai, LocalDateTime waktuSelesai, String status) {
