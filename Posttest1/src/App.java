...
import Service.BilikService;
import Service.JadwalPemakaianService;
...
public class App {
    ...
    private static void lihatBilik() {
        ...
        for (Bilik bilik : bilikList) {
            System.out.println("ID: " + bilik.getIdBilik() + ", Nomor: " + bilik.getNomorBilik() + ", Status: " + bilik.getStatus() + ", Spesifikasi: " + bilik.getSpesifikasiPc() + ", Harga per jam: " + bilik.getHargaPerjam());
        }
    ...
    private static void sewaBilik(Pelanggan pelanggan) {
        ...
        if (bilik != null && bilik.getStatus().equals("Tersedia")) {
            ...
            JadwalPemakaian jadwal = new JadwalPemakaian(0, 0, pelanggan.getIdPelanggan(), 0, idBilik, waktuMulai, waktuSelesai, "Aktif");
    ...
    private static void perpanjangSewa(Pelanggan pelanggan) {
        ...
        if (jadwal != null && jadwal.getIdPelanggan() == pelanggan.getIdPelanggan() && jadwal.getStatus().equals("Aktif")) {
